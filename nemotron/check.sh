...
PY
    ...
    "$mlx_python" "$repo_root/tests/nemotron_mlx_backbone_crossfit_test.py"
    "$mlx_python" "$repo_root/tests/nemotron_mlx_backbone_tier_screen_test.py"
    ...
    "$mlx_python" "$repo_root/tests/nemotron_mlx_topk_sweep_test.py"
    ...
    "$mlx_python" "$repo_root/tests/nemotron_mlx_mtp_teacher_capture_test.py"
    "$mlx_python" "$repo_root/tests/nemotron_mtp_teacher_prompts_test.py"
    "$mlx_python" "$repo_root/tests/nemotron_mlx_mtp_recursive_features_test.py"
    ...
    "$mlx_python" "$repo_root/tests/nemotron_mlx_trajectory_attribution_test.py"
    ...
    "$mlx_python" "$repo_root/tests/nemotron_mlx_router_distill_test.py"
    "$mlx_python" "$repo_root/tests/nemotron_mlx_kd_gradient_audit_test.py"
    "$mlx_python" "$repo_root/tests/nemotron_mlx_streamed_router_kd_test.py"
    ...
    "$mlx_python" "$repo_root/tests/nemotron_mlx_router_kd_export_test.py"
    ...
    "$mlx_python" "$repo_root/tests/nemotron_mlx_plan_compare_test.py"
    "$mlx_python" "$repo_root/tests/nemotron_mlx_layer_distill_test.py"
