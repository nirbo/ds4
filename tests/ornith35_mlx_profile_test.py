...
class MLXProfileTest(unittest.TestCase):
    ...
    def test_optimized_hotpath_flags_default_on_and_can_be_disabled(self) -> None:
        ...
        self.assertTrue(defaults.fused_gdn_beta_decay)
        self.assertTrue(defaults.fused_gdn_input_transition)
        ...
        self.assertFalse(fallback.fused_gdn_beta_decay)
        self.assertFalse(fallback.fused_gdn_input_transition)
