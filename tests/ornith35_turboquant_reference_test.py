...
class TurboQuantReferenceTest(unittest.TestCase):
    def test_exact_target_codebooks_and_distortion(self) -> None:
        ...
        self.assertAlmostEqual(six.expected_total_mse, 0.0006370650502317371)
        self.assertEqual(len(six.centroids), 64)
        self.assertAlmostEqual(six.centroids[0], -six.centroids[-1])
        self.assertAlmostEqual(seven.expected_total_mse, 0.00016161664229278422)
        self.assertEqual(len(seven.centroids), 128)
        self.assertAlmostEqual(seven.centroids[0], -seven.centroids[-1])
    ...
    def test_physical_cache_accounting(self) -> None:
        ...
        self.assertEqual((k3q, v3, k4, k5, k6, k7), (100, 98, 130, 162, 194, 226))
