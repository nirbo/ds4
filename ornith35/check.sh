...
python3 "$repo_root/tests/ornith35_runtime_coordination_test.py"
...
if [ -x "$mlx_python" ]; then
    ...
    "$mlx_python" "$repo_root/tests/ornith35_mlx_turboquant_runtime_gate_test.py"
    "$mlx_python" "$repo_root/tests/ornith35_mlx_turboquant_coding_gate_test.py"
    "$mlx_python" "$repo_root/tests/ornith35_mlx_turboquant_norm_ablation_test.py"
    ...
    "$mlx_python" "$repo_root/tests/ornith35_mlx_cache_bench_test.py"
    "$mlx_python" "$repo_root/tests/ornith35_mlx_generation_context_gate_test.py"
    "$mlx_python" "$repo_root/tests/ornith35_mlx_cache_warm_test.py"
