...
def _load_append():
    ...
    _APPEND_PACKED_MSE7 = append_packed_mse7
    return (
        _APPEND_BF16,
        _APPEND_KV_BF16,
        _APPEND_KV_TRANSPOSED_BF16,
...
def append_packed_mse7(
    ...
    """Alias and update paired packed K7 payloads and their BF16 norms."""
    require(isinstance(position, int), "linear cache position must be an integer")
