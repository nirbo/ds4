#!/usr/bin/env python3
"""Paired synthetic crossover benchmark for BF16 and packed K8-MSE K/V."""
...
def make_inputs(length: int) -> tuple[mx.array, mx.array, mx.array, packed_cache.MLXPackedMSE8State]:
