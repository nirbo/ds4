...
PRODUCTION_EXACT_ATTENTION_LAYERS = frozenset((3, 7, 27, 31, 39))
PRODUCTION_K8_ATTENTION_LAYERS = frozenset((11, 19, 35))
PRODUCTION_K9_ATTENTION_LAYERS = frozenset((15, 23))
PRODUCTION_EXACT_HEAD_TOKENS = 256
PRODUCTION_EXACT_TAIL_TOKENS = 256
PRODUCTION_MINIMUM_HISTORY_TOKENS = 131_072
PRODUCTION_PROFILE = (
    "mixed-k8-k9-mse-fp32norm-exactl3-l7-l27-l31-l39-"
    "k9l15-l23-head256-tail256-min131072"
)
